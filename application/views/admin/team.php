...
<center><a style="padding: 15px; color: #14e113; color: #fff;  margin-top: 50px; display: inline-grid; background-color: crimson;
 " class="btn bnt-primary" href="<?php echo base_url()?>index.php/user/team_form ">Add New</a></center>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Our Team</h6>
              </div>
            </div>
...
foreach ($get as $value){ ?>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a  class="btn btn-primary" href="<?php echo base_url()?>index.php/user/team_delete/<?php echo $value['id']?>" onclick="return conform ('Are you sure?')"> Delete</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <?php } ?>
