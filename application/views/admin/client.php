...
<center><a style="padding: 15px; color: #14e113; color: #fff;  margin-top: 50px; display: inline-grid; background-color: crimson;
 " class="btn bnt-primary" href="<?php echo base_url()?>index.php/user/client_form ">Add New</a></center>
                                    ...
                                    <tbody>
                                        <tr>
                                           ...
                                           <td>
                                            ...
                                            <td>
                                                <a  class="btn btn-primary" href="<?php echo base_url()?>index.php/user/client_delete/<?php echo $value['id']?>" onclick="return conform ('Are you sure?')"> Delete</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <?php } ?>
